...
<!-- wp:post-title {"level":3,"isLink":true,"className":".lifeawesome-h3-alt-2","style":{"typography":{"lineHeight":"1.3","fontStyle":"normal","fontWeight":"500"},"elements":{"link":{"color":{"text":"var:preset|color|gv-color-text-primary"},":hover":{"color":{"text":"var:preset|color|gv-color-primary"}}}}},"fontSize":"largest","fontFamily":"host-grotesk"} /-->
