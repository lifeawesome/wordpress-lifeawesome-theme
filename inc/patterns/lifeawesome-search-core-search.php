 ...
 */
return array(
	'title'      => __( 'LifeAwesome Search Core Search', 'lifeawesome' ),
...
<div class="wp-block-group"><!-- wp:post-template {"className":"lifeawesome-post-template","style":{"spacing":{"blockGap":"40px"}}} -->
...
<!-- wp:post-title {"isLink":true,"className":"lifeawesome-h3-alt-2","style":{"typography":{"lineHeight":"1","fontStyle":"normal","fontWeight":"500"},"elements":{"link":{"color":{"text":"var:preset|color|gv-color-text-primary"},":hover":{"color":{"text":"var:preset|color|gv-color-primary"}}}}},"fontSize":"largest","fontFamily":"host-grotesk"} /-->
