 ...
 */
return array(
	'title'      => __( 'LifeAwesome Search Gutenverse Hero', 'lifeawesome' ),
...
<div class="wp-block-gutenverse-column guten-element guten-column guten-TMTnXW"><div class="guten-column-wrapper" data-id="TMTnXW"><!-- wp:gutenverse/search-result-title {"elementId":"guten-RuovZ8","alignment":{"Desktop":"center"},"typography":{"type":"variable","id":"gv-font-feature-alt","font":{"label":"Host Grotesk","value":"Host Grotesk","type":"google"},"size":{"Desktop":{"unit":"px","point":"40"},"Mobile":{"unit":"px","point":"32"}},"lineHeight":{"Desktop":{"unit":"em","point":"1.2"},"Mobile":{"unit":"px"},"Tablet":{"unit":"px"}}},"color":{"type":"variable","id":"gv-color-text-primary"}} -->
<div class="guten-element guten-search-result-title guten-RuovZ8"></div>
