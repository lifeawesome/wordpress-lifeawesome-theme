 ...
 */
return array(
	'title'      => __( 'LifeAwesome Single Core Hero', 'lifeawesome' ),
...
<div class="wp-block-group"><!-- wp:post-terms {"term":"category","textAlign":"center","style":{"typography":{"fontStyle":"normal","fontWeight":"600","lineHeight":"1","textTransform":"uppercase"},"elements":{"link":{"color":{"text":"var:preset|color|gv-color-primary"}}}},"textColor":"gv-color-primary","fontSize":"mini","fontFamily":"host-grotesk"} /-->

<!-- wp:post-title {"textAlign":"center","className":"lifeawesome-h2-alt-2","style":{"typography":{"fontStyle":"normal","fontWeight":"500"},"elements":{"link":{"color":{"text":"var:preset|color|gv-color-text-primary"}}}},"textColor":"gv-color-text-primary","fontSize":"jumbo","fontFamily":"host-grotesk"} /-->

<!-- wp:group {"className":"lifeawesome-post-details","style":{"layout":{"selfStretch":"fit","flexSize":null},"spacing":{"blockGap":"16px"}},"layout":{"type":"flex","flexWrap":"nowrap","verticalAlignment":"top","justifyContent":"center"}} -->
<div class="wp-block-group lifeawesome-post-details"><!-- wp:post-author-name {"style":{"elements":{"link":{"color":{"text":"var:preset|color|gv-color-text-primary"}}},"typography":{"lineHeight":"1","fontStyle":"normal","fontWeight":"600"},"layout":{"selfStretch":"fit","flexSize":null}},"textColor":"gv-color-text-primary","fontSize":"mini","fontFamily":"host-grotesk"} /-->
